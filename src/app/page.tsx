...
export default function IGReelsDownloader() {
  const [, setNavOpen] = useState<boolean>(false);
    ...
    <div className="min-h-screen font-bold flex flex-col bg-gradient-to-t from-sky-500 to-pink-500 text-white p-4">
      ...
      <header className="w-full flex items-center justify-between p-4 bg-white bg-opacity-10 backdrop-blur-md rounded-[50px] text-white mb-4">
        ...
        <nav className="hidden md:flex space-x-4">
          ...
          <a href="./msg" className="text-white hover:text-pink-500">Services</a>
      ...
      <div className="flex flex-col items-center justify-center space-y-6">
        ...
        <div className="w-full max-w-md flex items-center relative top-[-350px] bg-white bg-opacity-10 backdrop-blur-md rounded-[50px] text-white border border-pink-500 p-2">
          <img
            aria-hidden="true"
            alt="link-icon"
            src="/link.png"
        ...
        {data && (
          <div className="w-full max-w-m relative top-[-350px]">
            <div className="bg-white bg-opacity-10 backdrop-blur-md rounded-lg p-4 text-white">
              ...
              <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4">
                <a
                  ...
                  download
                  className="bg-pink-500 hover:bg-pink-700 text-white font-bold py-2 px-4 rounded text-center"
                >
                  Download Reel
                </a>
                <a
        ...
        {/* About Section */}
        <div className="p-4 bg-white bg-opacity-10 backdrop-blur-md rounded-lg text-white mb-4  w-screen">
        ...
        <div className="p-4 bg-white bg-opacity-10 backdrop-blur-md rounded-lg text-white mb-4 w-screen">
          ...
          <div className="flex items-center space-x-4">
            <img src="/yash.jpg" alt="Yash Mhatre" className="w-20 h-30  rounded-[10px] shadow-md" />
            <div>
              <h3 className="text-xl font-bold">Yash Mhatre</h3>
              <p className="text-sm">App Developer and Web Developer</p>
            </div>
          </div>
        </div>
